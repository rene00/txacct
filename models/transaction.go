...
var TransactionWhere = struct {
	...
	ID:   whereHelperint{field: "\"transaction\".\"id\""},
	Memo: whereHelperstring{field: "\"transaction\".\"memo\""},
}
...
var (
	transactionAllColumns            = []string{"id", "memo"}
	transactionColumnsWithoutDefault = []string{"memo"}
